...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO Usuarios(Id, Nombre_usuario, Correo, Contraseña, Cumpleaños, Telefono, N°) VALUES ('$documento', '$nombre', '$correo', '$clave', '$fechaCumpleaños', '$telefono', '$categoria');";
